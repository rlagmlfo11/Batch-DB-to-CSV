...
//		databaseReader
//				.setSql("SELECT age, gender, mail, name, boss, wage FROM player order by age");
////		databaseReader.setSql(
////				"SELECT name, age, gender, mail, wage, boss FROM player ORDER BY CAST(SUBSTRING(age, LENGTH(age) - POSITION('/', REVERSE(age)) + 2, LENGTH(age)) AS INT) ASC");
